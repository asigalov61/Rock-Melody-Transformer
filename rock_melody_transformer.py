...
Original file is located at
    https://colab.research.google.com/drive/1VJgSrSo8XYzHRPi2zHzFdq_fRjL62zCE
...
outy = [random.randint(0, 24)+2056] + [0]
...
for c in tqdm.tqdm(comp_tokens[:number_of_chords_to_generate]):
